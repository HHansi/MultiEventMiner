...
class SampleBasket:
    ...
    def __init__(self, id_internal: str, raw: dict, id_external=None, samples=None):
        """
        :param id: A unique identifying id. Used for identification within FARM2.
        :type id: str
        :param external_id: Used for identification outside of FARM2. E.g. if another framework wants to pass along its own id with the results.

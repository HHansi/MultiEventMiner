...
class Tokenizer:
    ...
    def load(cls, pretrained_model_name_or_path, revision=None, tokenizer_class=None, use_fast=True, **kwargs):
        ...
        :param use_fast: (Optional, False by default) Indicate if FARM2 should try to load the fast version of the tokenizer (True) or
    ...
    def _infer_tokenizer_class(pretrained_model_name_or_path):
        ...
        try:
            ...
            # FARM2 model (no 'config.json' file)
            try:
